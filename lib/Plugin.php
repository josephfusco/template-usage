...
class Plugin {
	...
	private function define_admin_hooks() : void {
		...
		$plugin_basename = plugin_basename( dirname( __FILE__, 2 ) ) . '/template-usage.php';

		$this->loader->add_action( 'network_admin_menu', $plugin_admin, 'register_network_admin_page' );
		$this->loader->add_action( 'network_admin_edit_template_usage', $plugin_admin, 'update_options' );
	 ...
	 */
	public function get_loader() : Template_Usage_Loader {
		return $this->loader;
	}
	...
	public static function get_plugin_version() : string {
		$plugin_version = '';
		$path           = plugin_dir_path( dirname( __FILE__ ) ) . 'template-usage.php';
